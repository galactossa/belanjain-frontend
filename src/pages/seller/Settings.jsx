      ...
      <div className="w-full min-h-screen bg-[#f6f8fc] p-8">
        ...
        <div className="flex items-start justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <div className="h-12 w-[280px] rounded-2xl bg-white border border-slate-200 px-4 flex items-center gap-3 shadow-sm">
              <input
                type="text"
                placeholder="Cari pesanan atau produk..."
                className="bg-transparent outline-none w-full text-sm font-semibold placeholder:text-slate-400"
              />
            </div>
            ...
            <div className="relative">
              <button
                ...
                className="relative w-12 h-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center shadow-sm"
              >
            ...
            <button className="h-12 px-6 rounded-2xl bg-blue-600 text-white font-black text-sm shadow-lg hover:bg-blue-700 duration-300">
              + PRODUK BARU
            </button>
          </div>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <div className="bg-white rounded-[32px] border border-slate-200 p-8 shadow-sm flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-black text-slate-900">Pengaturan</h2>
              <p className="text-slate-400 uppercase tracking-[2px] text-sm font-bold mt-2">
                Atur bahasa preferensi, sistem notifikasi, logo aplikasi dan
                konfigurasi keamanan
              </p>
            </div>
            <button className="h-12 px-6 rounded-2xl border border-blue-500 text-blue-600 font-black text-sm">
              ACTIVE SETTINGS
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-[30px] border border-slate-200 p-8 shadow-sm">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className={`w-full h-14 rounded-2xl px-5 text-left font-bold transition-all ${
                    language === "id"
                ...
                <button
                  ...
                  className={`w-full h-14 rounded-2xl px-5 text-left font-bold flex items-center justify-between transition-all ${
                    language === "en"
                      ? "border-2 border-blue-500 text-blue-600"
                      : "border border-slate-200"
                  }`}
            ...
            <div className="bg-white rounded-[30px] border border-slate-200 p-8 shadow-sm">
              ...
              <input
                type="text"
                className="w-full mt-2 h-14 rounded-2xl border border-slate-200 px-4 outline-none"
