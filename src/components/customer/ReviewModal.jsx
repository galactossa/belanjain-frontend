...
export default function ReviewModal({ show, onClose, order, onSubmit }) {
  ...
  const handleSubmit = () => {
    ...
    // 🔥 PASTIKAN ADA PRODUK
    if (!product) {
      alert("Tidak ada produk untuk diulas");
      return;
    }
    ...
    const payload = {
      ...
      rating: rating,
      review: review.trim() || "Produk bagus!",
      photos: photos,
    };
      ...
      <div className="relative bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-2 w-full rounded-2xl border p-4 resize-none outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <div className="mt-2 border-2 border-dashed border-slate-200 rounded-2xl p-6">
              <input
                id="review-photo"
                type="file"
                accept="image/*"
              ...
              <div className="text-center">
                ...
                <label
                  ...
                  className="inline-block mt-3 px-5 py-2 rounded-xl border cursor-pointer text-sm font-bold hover:bg-slate-50"
                >
                  PILIH FOTO
                </label>
              </div>
        ...
        <div className="border-t p-5 flex gap-3">
          <button
            ...
            className="flex-1 h-12 rounded-xl bg-blue-600 text-white font-black tracking-wide hover:bg-blue-700"
          >
            KIRIM ULASAN PRODUK
          </button>
          <button
            onClick={onClose}
            className="px-6 h-12 rounded-xl bg-slate-100 font-bold hover:bg-slate-200"
          >
            BATAL
          </button>
        </div>
